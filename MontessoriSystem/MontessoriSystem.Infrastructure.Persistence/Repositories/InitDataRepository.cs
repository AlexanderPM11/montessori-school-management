...
{
    public class InitDataRepository: GenericRepository<InitData>, IInitDataRepository
    {
        private readonly ApplicationContext _dbContext;

    public InitDataRepository(ApplicationContext applicationContext) : base(applicationContext)
    {
