...
{
    public class RelationshipPersonRepository:GenericRepository<RelationshipPerson>, IRelationshipPersonRepository
    {
        private readonly ApplicationContext _dbContext;

        public RelationshipPersonRepository(ApplicationContext applicationContext) : base(applicationContext)
        {
