...
{
    public class RoomTeacherRepository: GenericRepository<RoomTeacher>, IRoomTeacherRepository
    {
        private readonly ApplicationContext _dbContext;

        public RoomTeacherRepository(ApplicationContext applicationContext) : base(applicationContext)
        {
