...
{
    public class TipoAdjuntoRepository: GenericRepository<TipoAdjunto>, ITipoAdjuntoRepository
    {
        private readonly ApplicationContext _dbContext;

        public TipoAdjuntoRepository(ApplicationContext applicationContext) : base(applicationContext)
        {
