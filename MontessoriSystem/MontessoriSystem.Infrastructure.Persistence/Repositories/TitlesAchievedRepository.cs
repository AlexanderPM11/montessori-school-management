...
{
    public class TitlesAchievedRepository:GenericRepository<TitlesAchieved>, ITitlesAchievedRepository
    {
        private readonly ApplicationContext _dbContext;

        public TitlesAchievedRepository(ApplicationContext applicationContext) : base(applicationContext)
        {
