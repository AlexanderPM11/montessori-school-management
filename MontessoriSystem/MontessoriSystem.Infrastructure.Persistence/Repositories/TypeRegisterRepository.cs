...
{
    public class TypeRegisterRepository:GenericRepository<TypeRegister>, ITypeRegisterRepository
    {
        private readonly ApplicationContext _dbContext;

        public TypeRegisterRepository(ApplicationContext applicationContext) : base(applicationContext)
        {
