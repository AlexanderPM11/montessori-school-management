...
export const DesktopUserTable: FC<DesktopUserTableProps> = ({
  users,
  onToggleStatus,
}) => {
  ...
  const LOCAL_STORAGE_KEY = "user-table-page-size";
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex gap-2 items-center">
            <Link
              to={`/users/edit-create?idUser=${row.original.id}`}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div ref={scrollRef} className="overflow-x-auto">
            <div className="h-[600px] flex flex-col">
              <TableDisplay table={table} toLink="/users/edit-create" />
