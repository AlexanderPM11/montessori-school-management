...
import { ChangePasswordFormik } from "../../Formik/Auth/ChangePasswordFormik";
      ...
      <div>
        <div className="min-h-screen bg-white text-gray-900 flex justify-center">
          <div className="max-w-screen-xl m-0 sm:m-10  sm:rounded-lg flex justify-center flex-1">
            ...
            <div className="lg:w-1/2 xl:w-5/12 p-0 sm:p-0 flex justify-center lg:justify-center flex-col ">
              ...
              <div className="mt-12 flex flex-col items-center">
                ...
                <div className=" max-w-[300px] text-center mt-5">
                  <p>Complete los datos para recuperar su contraseña</p>
                </div>
